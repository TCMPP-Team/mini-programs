...
let Attachments = class Attachments extends SuperComponent {
    constructor() {
        super(...arguments);
        this.options = {
            multipleSlots: true,
        ...
        this.methods = {
            onFileWrapTap(e) {
                ...
                const item = (_a = this.data.files) === null || _a === void 0 ? void 0 : _a[index];
                if (item) {
            ...
            setFiles() {
                this.setData({
                    files: this.properties.items.map((item) => (Object.assign(Object.assign({}, item), { fileType: this.data.renderFileType(item), desc: this.data.renderDesc(item), fileIcon: this.data.renderIcon(item) }))),
                });
            },
        };
        this.lifetimes = {
