...
function parseOptions(options, keys) {
    ...
    const disabled = (_c = keys === null || keys === void 0 ? void 0 : keys.disabled) !== null && _c !== void 0 ? _c : 'disabled';
    ...
    constructor() {
        ...
        this.methods = {
            ...
            handleSelect(e) {
                ...
                if (item[(_b = keys === null || keys === void 0 ? void 0 : keys.disabled) !== null && _b !== void 0 ? _b : 'disabled']) {
                    return;
                }
                this.triggerEvent('pick', {
                    value: item[(_c = keys === null || keys === void 0 ? void 0 : keys.value) !== null && _c !== void 0 ? _c : 'value'],
                    label: item[(_d = keys === null || keys === void 0 ? void 0 : keys.label) !== null && _d !== void 0 ? _d : 'label'],
                    index,
                    level,
                });
                ...
                if (((_f = item === null || item === void 0 ? void 0 : item[(_e = keys === null || keys === void 0 ? void 0 : keys.children) !== null && _e !== void 0 ? _e : 'children']) === null || _f === void 0 ? void 0 : _f.length) >= 0) {
                    this.setData({
                        selectedIndexes,
