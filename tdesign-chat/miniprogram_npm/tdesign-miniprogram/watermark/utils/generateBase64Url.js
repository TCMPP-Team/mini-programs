...
export default function generateBase64Url(canvas, { width, height, gapX, gapY, offsetLeft, offsetTop, rotate, alpha, watermarkContent, lineSpace, watermarkColor, layout, }, onFinish) {
    ...
    const contents = Array.isArray(watermarkContent) ? watermarkContent : [Object.assign({}, watermarkContent)];
    let top = 0;
    ...
    // 绘制水印内容
    const renderWatermarkItem = (item, offsetX = 0, offsetY = 0, rotateX = 0, rotateY = 0) => {
        var _a, _b;
        if (item.url) {
            ...
            img.onload = () => {
                var _a, _b;
                (_a = ctx.save) === null || _a === void 0 ? void 0 : _a.call(ctx);
                ...
                (_b = ctx.restore) === null || _b === void 0 ? void 0 : _b.call(ctx);
                // 图片加载完成再返回
                imageLoadCount += 1;
            ...
            const fillStyle = (item === null || item === void 0 ? void 0 : item.fontColor) || watermarkColor;
            (_a = ctx.save) === null || _a === void 0 ? void 0 : _a.call(ctx);
            drawRotate(ctx, rotateX, rotateY, rotate);
