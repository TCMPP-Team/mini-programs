    ...
    constructor() {
        ...
        this.methods = {
            ...
            updateSelected(index, trigger) {
                ...
                this._selectedValue = (_a = formatOptions[index]) === null || _a === void 0 ? void 0 : _a[keys === null || keys === void 0 ? void 0 : keys.value];
                this._selectedLabel = (_b = formatOptions[index]) === null || _b === void 0 ? void 0 : _b[keys === null || keys === void 0 ? void 0 : keys.label];
                if (trigger) {
            ...
            update() {
                ...
                if (optionsCount > 500) {
                    ...
                    const valueMap = new Map(formatOptions.map((item, idx) => [item[keys === null || keys === void 0 ? void 0 : keys.value], idx]));
                    index = (_a = valueMap.get(value)) !== null && _a !== void 0 ? _a : -1;
                }
                else {
                    index = formatOptions.findIndex((item) => item[keys === null || keys === void 0 ? void 0 : keys.value] === value);
                }
            ...
            updateVisibleOptions(offset, isFastScroll = false) {
                ...
                // 只有当可见范围发生变化时才更新
                if (visibleRange.startIndex !== this.data.virtualStartIndex ||
            ...
            getCurrentSelected() {
                ...
                return {
                    index: currentIndex,
                    value: (_a = formatOptions[currentIndex]) === null || _a === void 0 ? void 0 : _a[keys === null || keys === void 0 ? void 0 : keys.value],
                    label: (_b = formatOptions[currentIndex]) === null || _b === void 0 ? void 0 : _b[keys === null || keys === void 0 ? void 0 : keys.label],
                };
            },
        };
    }
