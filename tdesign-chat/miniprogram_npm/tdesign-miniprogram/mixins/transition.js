        ...
        methods: {
            ...
            enter() {
                ...
                if (typeof duration === 'number' && duration > 0) {
                    ...
                    this.transitionT = setTimeout(this.status === 'entering' ? this.entered.bind(this) : null, transitionDurations + 30);
                }
            },
            entered() {
            ...
            leave() {
                ...
                if (typeof duration === 'number' && duration > 0) {
                    ...
                    this.transitionT = setTimeout(this.status === 'leaving' ? this.leaved.bind(this) : null, transitionDurations + 30);
                }
            },
            leaved() {
                this.customDuration = false;
