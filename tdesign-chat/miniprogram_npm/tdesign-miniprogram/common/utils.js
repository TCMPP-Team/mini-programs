...
export const getTreeDepth = (tree, key) => {
    return tree.reduce((maxDepth, node) => {
        if (node[key !== null && key !== void 0 ? key : 'children'] && node[key !== null && key !== void 0 ? key : 'children'].length > 0) {
            return Math.max(maxDepth, getTreeDepth(node[key !== null && key !== void 0 ? key : 'children'], key) + 1);
        }
 ...
 */
export const isWxWork = (deviceInfo === null || deviceInfo === void 0 ? void 0 : deviceInfo.environment) === 'wxwork';
export const isPC = ['mac', 'windows'].includes(deviceInfo === null || deviceInfo === void 0 ? void 0 : deviceInfo.platform);
...
export const isOverSize = (size, sizeLimit) => {
    ...
    const computedSize = typeof sizeLimit === 'number' ? sizeLimit * base : (sizeLimit === null || sizeLimit === void 0 ? void 0 : sizeLimit.size) * unitMap[(_a = sizeLimit === null || sizeLimit === void 0 ? void 0 : sizeLimit.unit) !== null && _a !== void 0 ? _a : 'KB']; // 单位 KB
