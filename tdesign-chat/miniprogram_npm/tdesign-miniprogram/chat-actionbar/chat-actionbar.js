...
let ChatActionbar = class ChatActionbar extends SuperComponent {
    constructor() {
        super(...arguments);
        this.options = {
            multipleSlots: true,
        ...
        this.methods = {
            ...
            handleCopy() {
                if (!this.data.content)
                    return;
                const copyContent = this.data.copyMode === 'markdown' ? this.data.content : this.data.filterSpecialChars(this.data.content);
                this.triggerEvent('actions', {
                    name: 'copy',
                    data: copyContent,
                });
